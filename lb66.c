...
float main()
{
	...
	//условие для анализа рязрядов и вывода четных
	...
	//ввод данных с клавиатуры
	puts("Введите x1 и y1");
	scanf_s("%f%f", &x1, &y1);

	//условный оператор
	if (pow(x1, 2) + pow(y1, 2) <= 25 && pow(x1, 2) + pow(y1, 2) >= 9 && x >= 0)
		puts("Точка принадлежит промежутку");
	else puts("Точка не принадлежит промежутку");
	//при x = 0 и y = 4 точка должна принадлежать промежутку
	//при x = 10 и y = 10 точка не должна принадлежать промежутку
}